<?php namespace App\Http\Controllers;
	...
	class AdminAllLeadsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Status','name'=>'status','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'lead;contact;win;lose'];
	    ...
	    public function hook_query_index(&$query) {
	        //Your code here
					...
					if (CRUDBooster::myPrivilegeId() > 2) {
						// code...
						$query->where('parent', '=', CRUDBooster::myID());
					}
	    }
	    ...
	    */
	    public function hook_row_index($column_index,&$column_value) {
	    	//Your code here
				if ($column_index == 5) {
					// code...
					$client_input = DB::table('client_input')->where('client_id',$column_value)->orderby('id','desc')->first();
					if($client_input){
						$column_value = $client_input->message;
					}
				}
				if ($column_index == 7) {
					// code...
