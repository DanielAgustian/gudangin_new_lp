    ...
    <div class="home-contents">
        ...
        <div class="home-division">
            <div class="container">
                ...
                <h3 class="title-division">Sini biar <span>gudangin</span>  yang urusin <br> tanpa perlu keringetan!</h3>
                <p class="p-explain">gudangin hadir untuk memudahkan operasional bisnis online sesuai kebutuhanmu. Mulai dari manajemen gudang penyimpanan dan quality controlnya, packing, pengiriman, manajemen stok barang, apapun jenis dan besarnya usahamu. Jadi kamu bisa fokus ke pengembangan bisnis dan inovasi produk</p>
                <a href=""><p>Pelajari lebih lanjut mengenai Cara Kerja gudangin <img src="{{asset('images/icons/arrow-right.svg')}}" alt=""></p></a>
            </div>
                ...
                <div class="box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-9">
                            ...
                            <p class="p-explain">Lamanya waktu yang diperlukan oleh sistem automasi untuk memproses orderan dari saat terjadi di marketplace hingga tahap siap di pick-up kurir
                            </p>
                        </div>
                        <div class="col-lg-2 col-md-3">
                            <div class="number-box" >
                        ...
                        <div class="col-lg-10 col-md-9">
                            ...
                            <p class="p-explain">Tanpa input manual, keterlambatan maupun kesalahan pemrosesan orderan yang disebabkan oleh human-error terminimalisir
                            </p>
                        </div>
                        <div class="col-lg-2 col-md-3">
                            <div class="number-box" >
                        ...
                        <div class="col-lg-10 col-md-9">
                            ...
                            <p class="p-explain">90% pengurangan penggunaan space ruangan untuk operasional toko dan  80% penghematan biaya (upah) admin untuk operasional toko
                            </p>
                        </div>
                        <div class="col-lg-2 col-md-3">
                            <div class="number-box" >
                        ...
                        <div class="col-lg-10 col-md-9">
                            ...
                            <p class="p-explain">Manajemen Stok yang lebih rapih dan terkontrol, karena inbound dan outbound terjadi secara real-time
                            </p>
                        </div>
                    </div>
                </div>
