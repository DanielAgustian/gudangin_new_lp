        ...
        <div class="home-division">
            <div class="container">
                <div class="container-child">
                    ...
                    <h3 class="title-division">Sini biar <span>gudangin</span> yang urusin <br class="responsive-br"> tanpa perlu keringetan!</h3>
        ...
        <div class="home-division">
            ...
            <div class="container">
                <div class="stay-at-home-container">
                    ...
                    <div class="flex">
                        <button class="button-orange">COBA GRATIS</button>
                    </div>
                </div>
            </div>
        </div>
