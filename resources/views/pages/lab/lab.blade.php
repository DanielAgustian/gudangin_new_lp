        ...
        <div class="container" style="position: relative; z-index: 3">
            <div class="inner__container">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-lg-7 hero__right">
                ...
                <div class="row">
                    ...
                    <div class=" col-lg-8">
                      <div class="w-100 position-relative">
                        <div class=" marker marker-jakarta" data-type='jakarta'  data-toggle="tooltip" data-html="true" data-placement="top" title="Ruko Crystal 8 No. 17-18 <br>Alam Sutera, Tangerang Selatan <br>Banten 15320">
        ...
        <div id="problem_group-2" style="overflow: hidden; margin-bottom: 15px">
            <div class="problem_wrap">
                ...
                <div class="problem_item" style="">
                    <div class="card">
                        <div class="card-body">
                            <img src="{{asset('images/client/twg.png')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
