    ...
    <div class="row ">
      ...
      <div class="col-md-6">
        <div class="card shadow" style="background: white;">
          <div class="card-body">
            <form class=" register__section form-contact" method="POST" action= "{{route('contactUsPost')}}" style="position: relative">
              @csrf
      ...
      <div class="col-md-6">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15864.764093506465!2d106.6514294!3d-6.2385354!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xce2a00aeec086f67!2sYOKESEN!5e0!3m2!1sen!2sid!4v1646816084802!5m2!1sen!2sid" class="map-data" style="border:0;" allowfullscreen="" loading="lazy" class=""></iframe>
