...
@section('content')
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col-lg-5 hero__left">
                        <div class="home__hero_left">
                            ...
                            <h6>Gudangin hadir untuk memudahkan operasional bisnis online sesuai kebutuhanmu. Mulai dari
                                manajemen gudang penyimpanan dan quality control, packing, pengiriman, manajemen stok
                                barang, apapun jenis dan besarnya usahamu
                            </h6>
                        ...
                        <div class="swiper swiperBanner">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide"> <img
                                        src="{{ asset('images/new-home/marketplace-integration.png') }}" alt="img"></div>
                                <div class="swiper-slide"> <img src="{{ asset('images/new-home/tipbox.png') }}"
                                        alt="img"></div>
            ...
            <div class="inner__container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 home__benefit_left">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <img src="{{ asset('images/new-home/dukungan-order.png') }}" alt=""
                                    class="dukungan-img">
                                <h5>Order Management</h5>
                                <h6>Kamu buka hape aja, kita yang atur proses orderannya! Dengan <span>gudangin</span>
                                    proses order jadi mudah!
                                </h6>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <img src="{{ asset('images/new-home/dukungan-stock.png') }}" alt=""
                                    class="dukungan-img">
                                <h5>Product and Inventory Aggregation</h5>
                                <h6>Punya beberapa toko di beda-beda platform? Pusing karena barang suka habis karena susah
                                    hitungnya? Pusing stok opname? Tenang aja, <span>gudangin</span> bisa bantu kamu!
                                </h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 home__benefit_right">
                        <div class="card">
                            <div class="card-body">
                                <img src="{{ asset('images/new-home/dukungan-one-stop.png') }}" alt=""
                                    class="dukungan-img">
                                <h5>One Stop Packing Management System</h5>
                                <h6>Aduh ngurus pengiriman, retur dll itu katanya bikin pusing. Pakai aja
                                    <span>gudangin</span>, kita yang atur packing dan pengiriman yang memusingkan itu!
                                </h6>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <img src="{{ asset('images/new-home/dukungan-chat.png') }}" alt=""
                                    class="dukungan-img">
                                <h5>Integrated Chatting</h5>
                                <h6>Kelamaan balas chat di marketplace karena kebanyakan toko? Sudah tidak jaman!! Yuk pakai
                                    <span>gudangin</span>, tinggal buka websitenya dan chat ke semua marketplace! </h6>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <img src="{{ asset('images/new-home/dukungan-analytics.png') }}" alt=""
                                    class="dukungan-img">
                                <h5>Analytics</h5>
                                <h6>Mau tau performa tokomu untuk bulan ini? Mau tau apa yang mau diimprove? Pake
                                    <span>gudangin</span> aja, kita sudah punya sistem analytics yang canggih buat liat
                                    performa kamu kapan pun dan dimana pun! </h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="inner__container">
                <div class="row">
                    <div class=" col-lg-4 home__works_left">
                        ...
                        <h6>Gudangin
                            hadir untuk memudahkan operasional bisnis online sesuai kebutuhanmu. yuk lihat jangkauan
                            gudangin!</h6>

                    </div>
                    <div class=" col-lg-8">
                        <div class="w-100 position-relative">
                            <div class=" marker marker-jakarta" data-type='jakarta' data-toggle="tooltip" data-html="true"
                                data-placement="top"
                                title="Ruko Crystal 8 No. 17 <br>Alam Sutera, Tangerang Selatan <br>Banten 15320">
            ...
            <div class="inner__container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 order-md-2 order-1 mb-md-0 mb-4">
                        ...
                        <h6>Banyak banget barang yang sudah ditangani <span>gudangin</span>, dari sektor baju sampai makanan
                            pun bisa! Kapan lagi ada perusahaan yang sefleksibel ini! </h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="home__benefit section-form " data-aos="fade-up">
        ...
        <!-- <img src="{{ asset('images/ornament/benefit-wave.svg') }}" alt="" class="home__benefit_orn"> -->
        <div class="container">
            <h1 class="text-center mb-4" style="font-weight: 700">Diskusi Dengan <span> Team<strong>
                        gudangin</strong></span></h1>
            <div class="row ">
                <div class="col-md-6">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header justify-content-center">
                    <h5 class="modal-title text-center" style="color:#e36d1c" id="modalLabel">Gudangin Area Jabodetabek
                    </h5>
                    <!-- <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button> -->
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary btn-prim" style="border:none" data-dismiss="modal"
